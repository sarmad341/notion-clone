...
function FollowPointer({
  ...
  return (
    ...
    >
      ...
      >
        <path d="M14.082 2.182a.5.5 0 0 1 .103.557l-8.528 15.467a.5.5 0 0 1-.917-.007l-5.57 10.694.803 8.652a.5.5 0 0 1-.006-.916l12.728-5.657a.5.5 0 0 1 .556.103z"></path>
      </svg>
      <motion.div
        style={{
